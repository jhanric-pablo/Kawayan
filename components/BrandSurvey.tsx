  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="mb-8 flex flex-col items-center">
        ...
        <div className="w-full h-1 bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden max-w-sm">
           <div 
      ...
      {/* Card Container */}
      <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-xl border border-slate-100 dark:border-slate-700 p-8 min-h-[420px] relative overflow-hidden transition-colors">
        
        {/* Animated Background Blob */}
        <div className="absolute -top-20 -right-20 w-64 h-64 bg-emerald-50 dark:bg-emerald-900/20 rounded-full blur-3xl opacity-50 pointer-events-none"></div>
          ...
          <div className="animate-in fade-in slide-in-from-right-8 duration-500">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400 dark:text-slate-500">What is your business called?</p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <label className="block">
                ...
                <input
                  type="text"
                  className="w-full px-5 py-4 rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-900 text-slate-900 dark:text-white focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none transition text-lg"
          ...
          <div className="animate-in fade-in slide-in-from-right-8 duration-500">
             <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400 dark:text-slate-500">Who are we talking to?</p>
              </div>
            </div>
            <label className="block">
              <textarea
                className="w-full px-5 py-4 rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-900 text-slate-900 dark:text-white focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none transition h-48 resize-none text-lg leading-relaxed"
          ...
          <div className="animate-in fade-in slide-in-from-right-8 duration-500">
             <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400 dark:text-slate-500">How should your brand sound?</p>
              </div>
            </div>
                ...
                <button
                  ...
                  className={`p-4 rounded-2xl border text-left transition-all relative group ${
                    profile.brandVoice === t.label
                      ...
                      : 'border-slate-100 dark:border-slate-700 hover:border-emerald-300 dark:hover:border-emerald-600 hover:shadow-md dark:bg-slate-800'
                  }`}
                >
                  <div className="font-bold text-slate-800 dark:text-white group-hover:text-emerald-700 dark:group-hover:text-emerald-400 transition-colors">{t.label}</div>
          ...
          <div className="animate-in fade-in slide-in-from-right-8 duration-500">
             <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400 dark:text-slate-500">Key topics you want to cover.</p>
              </div>
            </div>
            <label className="block">
              <textarea
